...
describe('<SkipButton />', () => {
  ...
  it('should render successfully', () => {
    cy.mount(<SkipButton direction="prev" canSkip onClick={() => {}} />);
  });
  it('should point right on direction == next', () => {
    cy.mount(<SkipButton direction="next" canSkip onClick={() => {}} />);
  ...
  it('should not be disabled if it can skip', () => {
    ...
    cy.mount(<SkipButton direction="prev" canSkip onClick={onClickSpy} />);
  ...
  it("should be disabled if it can't skip", () => {
    const onClickSpy = cy.spy().as('onClickSpy');
    cy.mount(<SkipButton direction="prev" canSkip={false} onClick={onClickSpy} />);
